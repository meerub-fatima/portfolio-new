...
function Section() {
  ...
  return (
    ...
    <Flex dir="flex" justify="center" align="center">
      ...
      <VStack>
        <Box as="h1" textTransform="uppercase" mt="8" p="4">
          <Text  sx={{
          textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)'}}>web designer</Text></Box>
        </VStack>
